...
ENV SIM_BRIDGE_HOST host.docker.internal
ENV SIM_BRIDGE_PORT 1700

ENV GTW_NAME MIrriGateway
ENV GTW_MAC_ADDRESS 0000000000000001

ENV DEV_NAME Sensor01
