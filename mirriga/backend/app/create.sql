...
create table sensors (latitude float(53), longitude float(53), plantation_id bigint, id varchar(255) not null, name varchar(255), network_key varchar(255), primary key (id)) engine=InnoDB;
