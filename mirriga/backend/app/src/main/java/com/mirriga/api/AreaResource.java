...
import com.mirriga.dao.entities.CoordinateEntity;
import com.mirriga.exceptions.MirrigaException;
import com.mirriga.models.AreaRequestDto;
import com.mirriga.services.AreaService;
...
public class AreaResource {
    ...
    public Response createArea(AreaRequestDto request) throws MirrigaException {
    ...
    @Path("{id}")
    @Transactional(Transactional.TxType.REQUIRED)
    public Response updateArea(@PathParam("id") Long areaId, AreaRequestDto request) throws MirrigaException {
    ...
    @GET
    @Path("{id}")
    public Response getArea(@PathParam("id") Long areaId) throws MirrigaException {
    ...
    @Path("{id}")
    @Transactional(Transactional.TxType.REQUIRED)
    public Response deleteArea(@PathParam("id") Long areaId) throws MirrigaException {
