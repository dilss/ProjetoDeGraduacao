package com.mirriga.irrigation;
...
public class IrrigationService {
     ...
     */
    public Float getCAD(PlantationEntity plantation) throws MirrigaException {
     ...
     */
    public Double getLL(PlantationEntity plantation) throws MirrigaException {
     ...
     */
    public Double getLB(PlantationEntity plantation) throws MirrigaException {
